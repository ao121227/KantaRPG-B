...
execute if entity @s[tag=protection] if score @s magicCoolDown matches ..0 if score @s nowMp matches 25.. if score @s nowLv matches 4.. run function items/magic_command/magic/4101/run