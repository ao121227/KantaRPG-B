...
execute if score @s magicCoolDown matches ..0 if score @s nowMp matches 25.. if score @s nowLv matches 5.. run function items/magic_command/magic/6101.power/run