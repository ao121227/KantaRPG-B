...
execute if entity @s[tag=protection] if score @s magicCoolDown matches ..0 if score @s nowMp matches 35.. if score @s nowLv matches 6.. run function items/magic_command/magic/2101.waterattack/run