...
execute if entity @s[tag=strong] if score @s magicCoolDown matches ..0 if score @s nowMp matches 60.. if score @s nowLv matches 10.. run function items/magic_command/magic/1102/run