...
tp @s ^^^0.5
execute positioned ~~-1000~ if entity @e[tag=monster,r=2] as @e[tag=monster,r=2,c=1] at @s run function items/magic_command/magic/3001.earthball/hit
execute positioned ~~-1000~ run particle r:earth ~ ~1 ~
execute positioned ~~-1000~ run particle r:earth2 ~ ~1 ~
execute positioned ~~-1000~ run particle r:earth3 ~ ~1 ~
