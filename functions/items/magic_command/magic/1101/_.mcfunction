...
execute if entity @s[tag=strong] if score @s magicCoolDown matches ..0 if score @s nowMp matches 35.. if score @s nowLv matches 7.. run function items/magic_command/magic/1101/run