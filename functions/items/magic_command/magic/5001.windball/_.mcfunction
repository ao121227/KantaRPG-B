...
execute if entity @s[tag=protection] if score @s magicCoolDown matches ..0 if score @s nowMp matches 20.. run function items/magic_command/magic/5001.windball/run