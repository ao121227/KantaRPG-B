...
execute if entity @s[tag=strong] if score @s magicCoolDown matches ..0 if score @s nowMp matches 35.. if score @s nowLv matches 7.. run function magicFunction/magic/1101.circlefire/run