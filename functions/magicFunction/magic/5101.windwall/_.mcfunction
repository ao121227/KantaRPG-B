...
execute if entity @s[tag=protection] if score @s magicCoolDown matches ..0 if score @s nowMp matches 40.. if score @s nowLv matches 7.. run function magicFunction/magic/5101.windwall/run