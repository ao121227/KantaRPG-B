...
scoreboard players operation @s strong_maxMp = @s maxMp
...
execute unless entity @s[scores={protection_maxMp=0..}] run scoreboard players set @s protection_maxMp 100
...
scoreboard players operation @s maxMp = @s protection_maxMp
