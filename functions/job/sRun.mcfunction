...
scoreboard players operation @s protection_maxMp = @s maxMp
...
execute unless entity @s[scores={strong_maxMp=0..}] run scoreboard players set @s strong_maxMp 100
...
scoreboard players operation @s maxMp = @s strong_maxMp
